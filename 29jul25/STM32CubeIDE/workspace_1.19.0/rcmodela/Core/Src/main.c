...
void HAL_GPIO_EXTI_Callback(uint16_t GPIO_Pin)
{
    if(GPIO_Pin == GPIO_PIN_0)  // Check which pin triggered the EXTI
    {
      ...
      if((counter_exti0%2) == 1){
        ...
        //HAL_NVIC_DisableIRQ(EXTI0_IRQn);  // Disable EXTI Line 0 interrupt for check what is happend
        //HAL_Delay(600);
        //HAL_NVIC_EnableIRQ(EXTI0_IRQn);  // Re-enable EXTI Line 0 interrupt
...
//void HAL_GPIO_EXTI_Callback(uint16_t GPIO_Pin)
//{
//    if(GPIO_Pin == GPIO_PIN_4)  // Check which pin triggered the EXTI
//    {
//    	HAL_NVIC_DisableIRQ(EXTI4_IRQn);  // Disable EXTI Line 0 interrupt
//ndling code here
//        //do somthing
//        // Your EXTI ha
//        HAL_NVIC_EnableIRQ(EXTI4_IRQn);
...
//void HAL_GPIO_EXTI_Callback(uint16_t GPIO_Pin)
//{
//    if(GPIO_Pin == GPIO_PIN_1)  // Check which pin triggered the EXTI
//    {
////    	HAL_NVIC_DisableIRQ(EXTI1_IRQn);  // Disable EXTI Line 0 interrupt
//
//        // Your EXTI handling code here
//        //do somthing
