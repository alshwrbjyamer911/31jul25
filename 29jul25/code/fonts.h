...
// Example 7x10 font for ASCII 32..127
static const uint8_t font_7x10_data[] = {
    // Each character is 10 bytes (7x10 pixels, vertical scan)
    // Only space (32) and 'A' (65) shown for brevity
    // Space (32)
