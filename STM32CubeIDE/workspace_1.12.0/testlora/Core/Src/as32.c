...
const uint8_t p_reader[3]={0xC1 ,0xC1 ,0xC1};//cmd sent to module to read paarameter configured on module
extern uint8_t param[6];

const uint8_t general[2]={0,0};//

const uint8_t powersaving[2]={0,1};

const uint8_t wakeup[2]={1,0};/*/uart open wireless chalel open and the only differenace between it and general mode is
...
const uint8_t sleep[2]={1,1};// this mode we can configure  module on it
