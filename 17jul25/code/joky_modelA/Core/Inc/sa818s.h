...
#include <string.h>
#include <stdio.h>
#define SA818_UART_HANDLE huart1 // Example UART handle, replace with actual handle if different
...
extern UART_HandleTypeDef SA818_UART_HANDLE; // Example UART handle
