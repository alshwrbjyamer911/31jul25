...
int main(void)
{
  ...
  ILI9341_Init();
  HAL_Delay(1000);
//  ILI9341_DrawImageAt(image, 170, 2 , 60, 30);
//  ILI9341_DrawImageAt((const uint8_t*)stopwatch, 0, 0 , 40, 40);
  Display_LCD_UI();
  /* USER CODE END 2 */
  ...
  {
    /* USER CODE END WHILE */
//	  ILI9341_DrawImageAt((const uint8_t*)_less10, 170, 2 , IM_WEDTH, 60);
//	  HAL_Delay(1000);
//	  ILI9341_DrawImageAt((const uint8_t*)_20, 170, 2 , IM_WEDTH, IM_HIGHT);
//	  HAL_Delay(1000);
//	  ILI9341_DrawImageAt((const uint8_t*)_35, 170, 2 , IM_WEDTH, IM_HIGHT);
//	  HAL_Delay(1000);
//	  ILI9341_DrawImageAt((const uint8_t*)_50, 170, 2 , IM_WEDTH, IM_HIGHT);
//	  HAL_Delay(1000);
//	  ILI9341_DrawImageAt((const uint8_t*)_65, 170, 2 , IM_WEDTH, IM_HIGHT);
//	  HAL_Delay(1000);
//	  ILI9341_DrawImageAt((const uint8_t*)_85, 170, 2 , IM_WEDTH, IM_HIGHT);
//	  HAL_Delay(1000);
//	  ILI9341_DrawImageAt((const uint8_t*)_100, 170, 2 , IM_WEDTH, IM_HIGHT);
//	  HAL_Delay(1000);
//	  ILI9341_DrawImageAt((const uint8_t*)charging, 170, 2 , IM_WEDTH, IM_HIGHT);
//	  HAL_Delay(1000);
    /* USER CODE BEGIN 3 */
  }
  /* USER CODE END 3 */
...
//    ILI9341_DrawImageAt((const uint8_t*)stopwatch, 95, 180, 50, 60);                                   // Stopwatch icon
    ILI9341_DrawMonoImageAt(gImage_finals, 95, 180, 50, 60, 0x0000, 0xFEA0);
